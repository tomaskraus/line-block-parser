...
const jsCommentParser = Parser.create(Tags.js_block.start, Tags.js_block.end, {
  grouped: false,
...
//using its reducer
const groupedParser = Parser.create(Tags.js_block.start, Tags.js_block.end); //params: start tag, end tag
